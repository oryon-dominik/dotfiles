...
table.add_row()
table.add_row("", "CTRL + R", "Fzf: general-purpose command-line fuzzy finder - # TODO: now done by mcfly ", "https://github.com/junegunn/fzf")
table.add_row("", "F2", "change the intellisense autocompletion mode", "https://github.com/PowerShell/CompletionPredictor")
table.add_row()
