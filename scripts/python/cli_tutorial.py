...
table.add_row("", "aliases", "edit Locations for the local aliases in npp", "")
table.add_row()
...
table.add_row("", "mkvirtualenv" , "create a new venv in ~/Envs", "")
table.add_row("", "lsvirtualenv" , "lists all venvs in ~/Envs", "")
